...
def buildio(parent):
	...
	for index in range(31):
		...
		if inputText == 'Home':
			ioContents.append('net home-joint-{0} joint.{0}.home-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
		elif inputText == 'Both Limit':
			ioContents.append('net limits-joint-{0} joint.{0}.neg-lim-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
			ioContents.append('net limits-joint-{0} joint.{0}.pos-lim-sw-in\n'.format(inputJoint))
		elif inputText == 'Min Limit':
			ioContents.append('net min-limit-joint-{0} joint.{0}.neg-lim-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
		elif inputText == 'Max Limit':
			ioContents.append('net max-limit-joint-{0} joint.{0}.pos-lim-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
		elif inputText == 'Home & Limit':
			ioContents.append('net home-limit-joint-{0} joint.{0}.home-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
			...
			ioContents.append('net min-limit-home-joint-{0} joint.{0}.neg-lim-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
			ioContents.append('net min-limit-home-joint-{0} joint.{0}.home-sw-in\n'.format(inputJoint))
		elif inputText == 'Max Limit & Home':
			ioContents.append('net max-limit-home-joint-{0} joint.{0}.pos-lim-sw-in <= hm2_7i76e.0.7i76.0.0.input-{1:02}\n'.format(inputJoint, index))
			...
			ioContents.append('net digital-input-0 motion.digital-in-00 <= hm2_7i76e.0.7i76.0.0.input-{0:02}\n'.format(index))
		elif inputText == 'Digital In 1':
			ioContents.append('net digital-input-1 motion.digital-in-01 <= hm2_7i76e.0.7i76.0.0.input-{0:02}\n'.format(index))
		elif inputText == 'Digital In 2':
			ioContents.append('net digital-input-2 motion.digital-in-02 <= hm2_7i76e.0.7i76.0.0.input-{0:02}\n'.format(index))
		elif inputText == 'Digital In 3':
			ioContents.append('net digital-input-3 motion.digital-in-03 <= hm2_7i76e.0.7i76.0.0.input-{0:02}\n'.format(index))
